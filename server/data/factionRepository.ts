...
factions.push(
    ...
    create(
        ...
        createHardware('Seeker', 'Gain 1 Heat to give all your attacks -1TN this turn.', ['MAC']),
    ...
    create(
        ...
        createHardware('Spire', 'Short ranged power 1 weapon that has no type but can fire in any direction and does not generate Heat. Its power can never be increased.', ['MAC']),
    ...
    create(
        ...
        createHardware('Mindhive', 'When this unit activates, reveal the top card in the initiative deck then return it. You may then gain 1 Heat to shuffle the initiative deck.', ['All']),
    ...
    create(
        ...
        createHardware('Converter', 'Before each weapon attack you may change the subtype to Rad or Thermal.', ['All']),
    ...
    create(
        ...
        createHardware('Spine', 'When you collide cause an extra hit and take one less hit than normal.', ['All']),
    ...
    create(
        ...
        createHardware('Crucible', 'Lose 2 Heat in cooldown. When this module is hit gain 1 Rad.', ['MAC']),
